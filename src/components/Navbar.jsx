  ...
  return (
    <nav className="w-full flex items-center justify-between px-6 py-3 text-white shadow-md">
      ...
      <div className="flex items-center gap-6">
        <img src={upload} alt="upload" className="w-6 cursor-pointer hover:opacity-80" />
        <img src={more} alt="more" className="w-6 cursor-pointer hover:opacity-80" />
        <img src={notification} alt="notification" className="w-6 cursor-pointer hover:opacity-80" />
